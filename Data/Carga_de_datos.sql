...
En Windows, los archivos csv deben estar en C:\ProgramData\MySQL\MySQL Server 8.0\Uploads.
...
USE Aurelion_Dashboard; -- Selecciona la base de datos Aurelion


-- Se cargan los datos de cada archivo en su tabla correspondiente


LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Clientes.csv'  -- Ruta del archivo CSV en el servidor MySQL
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Detalle_ventas.csv' 
